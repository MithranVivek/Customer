...
public class BankCustomerController {
	...
	public String addBankCustomer(@RequestBody BankCustomer bankCustomer) throws BankCoustomerBranchNotFoundException {
	...
	public BankCustomer getBankCustomer(@PathVariable int id) {
